...
describe ForecastsService do
	it 'fetch_forecast()' do
		...
		expect(forecast_data[:timezone_offset]).to be_an(Integer)
		...
		expect(daily[:temp][:day]).to be_an(Integer).or be_a(Float)
		expect(daily[:temp]).to have_key(:min)
		expect(daily[:temp][:min]).to be_an(Integer).or be_a(Float)
		expect(daily[:temp]).to have_key(:max)
		expect(daily[:temp][:max]).to be_an(Integer).or be_a(Float)
		expect(daily[:temp]).to have_key(:night)
		expect(daily[:temp][:night]).to be_an(Integer).or be_a(Float)
		expect(daily[:temp]).to have_key(:eve)
		expect(daily[:temp][:eve]).to be_an(Integer).or be_a(Float)
		expect(daily[:temp]).to have_key(:morn)
		expect(daily[:temp][:morn]).to be_an(Integer).or be_a(Float)
		...
		expect(daily[:pressure]).to be_an(Integer).or be_a(Float)
		...
		expect(daily[:clouds]).to be_an(Integer).or be_a(Float)
		expect(daily).to have_key(:wind_speed)
		expect(daily[:wind_speed]).to be_an(Integer).or be_a(Float)
		expect(daily).to have_key(:wind_deg)
		expect(daily[:wind_deg]).to be_an(Integer).or be_a(Float)
